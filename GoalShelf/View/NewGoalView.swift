    ...
    var body: some View {
        ...
        */
        ...
        VStack(alignment: .leading, spacing: 9){
            ...
            TextField("Loosing 5 kg in 2 months!", text: $goalDescription).padding(.vertical, 12).padding(.horizontal, 15).background(.white.shadow(.drop(color: .black.opacity(0.25), radius: 2)), in: .rect(cornerRadius: 10))
        ...
        HStack{
            ...
            ZStack{
                RoundedRectangle(cornerRadius: 25.0).fill(LinearGradient(colors: eduSelected ? [.lightEducation,.strongEducation] : disabled, startPoint: .topLeading, endPoint: .bottomTrailing)).frame(width: 180, height: 100)
                VStack{
            ...
            ZStack{
                RoundedRectangle(cornerRadius: 25.0).fill(LinearGradient(colors: workSelected ? [.lightWork,.strongWork] : disabled, startPoint: .topLeading, endPoint: .bottomTrailing)).frame(width: 180, height: 100)
                VStack{
        ...
        HStack{
            ZStack{
                RoundedRectangle(cornerRadius: 25.0).fill(LinearGradient(colors: healthSelected ? [.lightHealth,.strongHealth] : disabled, startPoint: .topLeading, endPoint: .bottomTrailing)).frame(width: 180, height: 100)
                VStack{
            ...
            ZStack{
                ...
                RoundedRectangle(cornerRadius: 25.0).stroke(lineWidth: 2.0).fill(LinearGradient(colors: specialSelected ? [.red,.orange,.yellow,.green,.blue,.purple] : disabled, startPoint: .topLeading, endPoint: .bottomTrailing)).frame(width: 180, height: 100)
                VStack
                {
                    Image(systemName: "fireworks")
                    Text("Special")
                }.foregroundStyle(LinearGradient(colors: specialSelected ? [.red,.orange,.yellow,.green,.blue,.purple] : disabled, startPoint: .topLeading, endPoint: .bottomTrailing))
        ...
        .opacity(goalName == "" || goalDescription == "" ? 0.5 : 1)
    }
